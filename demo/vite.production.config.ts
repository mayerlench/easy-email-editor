...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@cubxinc/easy-email-core': path.resolve('../packages/easy-email-core'),
      '@cubxinc/easy-email-editor': path.resolve('../packages/easy-email-editor'),
      '@cubxinc/easy-email-extensions': path.resolve('../packages/easy-email-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
